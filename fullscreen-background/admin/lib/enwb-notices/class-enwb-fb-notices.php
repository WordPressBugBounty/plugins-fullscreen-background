...
if ( ! class_exists( 'Enwb_Fb_Notices' ) ) :
	...
	class Enwb_Fb_Notices {
		 ...
		 * @since 1.0.0
		 */
		private $plugin_name_dashed = FULLSCREEN_BACKGROUND_PLUGIN_NAME;
		 ...
		 * @since 1.0.0
		 */
		private static $version = FULLSCREEN_BACKGROUND_VERSION;
